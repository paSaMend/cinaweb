...
<body style="background-color: lightgoldenrodyellow">
      ...
      <div class="row" style="display: flex; justify-content: center; align-items: center;">
        ...
        <article class="col-xs-12 col-sm-6 col-md-4" style="">
          <div class="thumbnail">
              ...
              <div class="caption">
                <h3 class="text-center">Registrar Ova</h3>
                <p class="text-center"><a class="btn btn-primary" href="crudOVA.php">Registrar Ova</a></p>
              </div>
            </div>
        </article>
        ...
        <article class="col-xs-12 col-sm-6 col-md-4">
          <div class="thumbnail">
              ...
              <div class="caption">
                <h3 class="text-center">Listar Ova</h3>
                <p class="text-center"><a class="btn btn-primary" role="button"  href="listarO.php">Listar Ova</a></p>
              </div>
            </div>
        </article>
  ...
  <div class="modal fade" data-backdrop="static"  tabindex="-1" id="modalLOVA" role="dialog" aria-labelledby="exampleModalLabel">
 ...
 <div class="modal-content">
   ...
   <div class="modal-body">
     <form method="post" action="listarOVA.php">
     ...
     <div class="form-group">
      ...
      <button type="submit" name="submit" class="btn btn-primary" data-dismiss="modal">Guardar</a>
