...
<body style="background-color: lightgoldenrodyellow">
  ...
  <section class="full-reset" style="background-color: rgb(242, 242, 242); padding: 40px 0;">
    ...
    <div class="container">
      <form enctype="multipart/form-data"  method="post" action="controlador/listarOVA.php" >
  ...
  <section class="full-reset" style="background-color: rgb(242, 242, 242); padding: 40px 0;">
    ...
    <div class="col-md-8 col-md-offset-2">
        <table id="libreporelmomento" class="table table-striped table-bordered" cellspacing="0" width="100%">
            <thead>
            <tr>
                <th>Curso</th>
                <th>Grupo</th>
